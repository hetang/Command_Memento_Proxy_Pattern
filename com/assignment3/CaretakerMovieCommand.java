...
public class CaretakerMovieCommand {
	private MovieCommandMemento savedStates = null;
	
	public void addMemento(MovieCommandMemento objMemento) throws IOException {
	...
	public MovieCommandMemento getMemento() throws IOException, ClassNotFoundException {
		String filename = "command_memento.txt";
		...
		savedStates = (MovieCommandMemento) objInputStream.readObject();
